...
public class DepthFirstPathsTest {
    ...
    public void searchConnectedGraph() throws Exception {
        ...
        City start = allRoutes.get(0).getCity1();
        City end = allRoutes.get(6).getCity1();
        connected.add(allRoutes.get(0));
        connected.add(allRoutes.get(2));
        connected.add(allRoutes.get(3));
    ...
    public void searchUnConnectedGraph() throws Exception {
        ...
        City start = allRoutes.get(0).getCity1();
        City end = allRoutes.get(6).getCity1();
        unconnected.add(allRoutes.get(0));
        unconnected.add(allRoutes.get(2));
        unconnected.add(allRoutes.get(10));
        unconnected.add(allRoutes.get(4));
        unconnected.add(allRoutes.get(6));
